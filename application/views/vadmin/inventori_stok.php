              ...
              <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <h2>Stok<small>Inventori</small></h2>
                    ...
                    <div id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
						<div class="form-body">
							...
							<div class="form-group">
								<label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name">Per tanggal
									</label>
								<div class="col-md-8 col-sm-8 col-xs-12">
										<input type="text" name="tgl" class="form-control" placeholder="08/17/1945" required data-inputmask="'mask':'99/99/9999'" aria-describedby="inputSuccess2Status4" id="single_cal4">
						...
						<div class="form-group">
							...
							<button type="button" class="btn btn-success" onclick="view_stok()"><i class="glyphicon glyphicon-eye-open"></i> View</button>
							
							<button type="button" class="btn btn-primary" onclick="cetak_stok()"><i class="glyphicon glyphicon-print"></i> Cetak</button>
							</div>
						</div>
						...
						<script type="text/javascript">
							function cetak_stok(){
								...
								if(tgl == 0 || tgl==""){
								   var error = true;
								   alert("Maaf, Tanggal masih kosong");
								   return (false);
								}else{
									window.open('<?php echo base_url()."cadmin/laporan/cetak_stok/";?>'+tgl);
								}
							...
							function view_stok() {
								...
								$.ajax({
										type: "POST",
										url : "<?php echo site_url('cadmin/inventori/view_stok')?>",
										data: kode,
										beforeSend: function(){
										   // $("#loaderDiv").show();
										   loading.fadeIn();						
