			...
			<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
						<div class="row">
							<div class="col-lg-12">
							<?php echo form_open_multipart('cadmin/home/content_edit') ?>
								<div class="form-group">
									<label>Judul Content</label>
									<input type="hidden" name="id" value="<?php echo $rec['id'];?>">
									<input style="width: 100%;" name="judul" type="text" class="form-control" required="" value="<?php echo $rec['judul_content'];?>">
								</div>
								<div class="form-group">
									<label>Menu </label>
