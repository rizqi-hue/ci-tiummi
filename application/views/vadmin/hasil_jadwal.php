<div class="x_content">
<h2>JADWAL LAB <?php echo $this->app_model->find_lab($lab);?> <br/> <?php echo" ".$this->app_model->find_dosen($nidn);?> </h2>
	...
	<?php
		foreach($kata as $r){//waktu
			echo"<tr>";
				...
				echo"<td>";$tkelas=$this->app_model->find_jadwal_kelas($r->kode,$kelas,$smt,$thpel,$lab,$hari,$nidn);
				$trimkelas=str_replace('_','',$tkelas);
