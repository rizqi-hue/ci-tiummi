...
function save()
{
	...
	var data_nik	=$('[name="data-nik"]').val();
...
function cek_kelas()
{
	...
	// alert(thpel);
		var kode = {kelas:kelas_kode, nim:nim, thpel:thpel,data_nik:data_nik};
		$.ajax({
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">NIM (1 NIM) <span class="required">*</span>
								</label>
						...
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">NIM (Select All)
							</label>
							<pre id="example-console"></pre>
							<input type="hidden" name="data-nik" id="data-nik">
						</div>
						<div class="form-group">
...
<div class="modal fade" id="modal_form_mhs" role="dialog">
    <div class="modal-dialog" style="width:700px;">
        <div class="modal-content">
			...
			<form action="#" id="form_mhs" class="form-horizontal" method="post">
            <div class="modal-body form">
...
$(document).ready(function (){
   //datatables
	...
	table = $('#example').DataTable({ 
        ...
        // Load data for the table's content from an Ajax source
        "ajax": {
            "url": "<?php echo site_url('cadmin/tempati_kelas/mahasiswa_list')?>",
            "type": "POST"
        },
