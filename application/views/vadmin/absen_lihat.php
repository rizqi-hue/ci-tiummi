                  ...
                  <div class="x_content">
                    ...
                    <div id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
						...
						<div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
								<div class="input-group">
									<input type="text" name="matakul_kode" class="form-control" placeholder=" Kode MK" required >
						...
						<div class="form-group">
							...
							<button type="button" class="btn btn-success" onclick="view_absen()"><i class="glyphicon glyphicon-eye-open"></i> View</button>
							
							<button type="button" class="btn btn-primary" onclick="cetak_absen()"><i class="glyphicon glyphicon-print"></i> Cetak</button>
							</div>
						</div>
						...
						<script type="text/javascript">
							function cetak_absen(){
								...
								var matakul		=$('[name="matakul_kode"]').val();
								...
								if(kelas_kode == 0 || kelas_kode==""){
								   ...
								   return (false);
									...
									window.open('<?php echo base_url()."cadmin/laporan/cetak_absen/";?>'+kelas_kode+'/'+smt+'/'+matakul+'/'+thpel);
								}
							...
							function view_absen() {
								...
								var kode = {kelas:kelas_kode, smt:smt,lab:lab,thpel:thpel,matakul:matakul};
								$.ajax({
										type: "POST",
										url : "<?php echo site_url('cadmin/absen/view_lihat_absen')?>",
										data: kode,
										beforeSend: function(){
										   // $("#loaderDiv").show();
										   loading.fadeIn();						
